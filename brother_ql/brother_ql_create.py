...
def main():
    ...
    parser.add_argument('--600dpi', action='store_true', dest='dpi_600',
    ...
    parser.add_argument('--lq', action='store_false', dest='hq',
    ...
    create_label(qlr, args.image, args.label_size, threshold=args.threshold, cut=args.cut, rotate=args.rotate,
                 dither=args.dither, compress=args.compress, red=args.red, dpi_600=args.dpi_600, hq=args.hq)
